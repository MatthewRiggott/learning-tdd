...
feature "user views list of TV shows" do
  ...
  scenario "view list of TV shows" do
    ...
    #     synopsis: "A show where every character you build emotional attachment to dies."
    #   })
  ...
  scenario "view details for a TV show" do
    ...
    expect(page).to have_content("A show where every character you build emotional attachment to dies.")
  end
  scenario "view details for a TV show with missing information" do
    ...
    expect(page).to have_content("This show has no synopsis.")
  end
end
